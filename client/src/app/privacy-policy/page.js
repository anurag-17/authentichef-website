      ...
      <section>
        ...
        <div className="2xl:w-[1600px] xl:w-[1100px] lg:w-[850px]  md:w-[700px]  mx-auto 2xl:py-[150px] xl:py-[120px] py-[70px] mnavbar">
          <div>
              ...
              <table className="table border text-[#000000]">
                ...
                <tbody>
                  ...
                  <tr className="privacyText">
                    ...
                    <td className="py-5 w-6/12">
                      We may use your personal data to analyse how you use our
                  ...
                  <tr className="privacyText">
                    <td className="py-5 w-3/12">Reorganising our business</td>
                    <td className="py-5 w-6/12">
                      ...
                      purpose of analysing any proposed sale or re-organization.
            ...
            <p className="privacyText mb-7 2xl:mb-10">
              Authentichef uses cookies and other tracking technologies for the
              following purposes:
            </p>
            ...
            <p className="privacyText mb-7 2xl:mb-10">
              ...
              this Cookies Policy, please email us at support@authentichef.com.
            </p>
