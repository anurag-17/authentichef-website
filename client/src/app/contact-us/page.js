  ...
  return (
    <>
      <section>
        ...
        <section>
          <div className="2xl:w-[1600px] xl:w-[1100px] lg:w-[850px]  md:w-[800px] w-full px-10 md:px-0 text-center mx-auto 2xl:pt-[160px] xl:pt pt-[120px] mnavbar">
            <h1 className="globalhead">Get In Touch</h1>
            <div className="flex justify-center items-center bg-[#F3F3F3] 2xl:h-[322px] xl:h-[200px] lg:h-[150px] md:h-[120px] sm:h-[100px] h-[100px] sm:px-10 md:px-0 2xl:my-[45px] xl:my-[35px] my-[20px]">
              <div className="">
                <Image
                  src={mail}
