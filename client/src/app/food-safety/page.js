      ...
      <section>
        ...
        <div className="flex justify-center xl:py-28 lg:py-14 md:py-8 py-5 border-b-[1px] border-[#B1B1B1]">
          <div className="2xl:w-[1600px] xl:w-[1100px] lg:w-[850px] md:w-[700px] w-full flex items-center flex-col-reverse lg:flex-row mnavbar 2xl:pt-[135px] xl:pt-[60px] pt-[40px]">
            ...
            <div className="mx-4 sm:w-1/2 flex sm:mx-auto my-5 lg:my-0 lg:flex-none">
              <Image
                alt="image"
                src={eightPoster}
                className="2xl:w-[724px] 2xl:h-[507px] w-full h-auto mx-auto rounded-[15px] meightPoster"
              />
            </div>
          </div>
        </div>
        ...
        <div className="bg-[#F5C7C7] 2xl:py-[115px] xl:py-[80px] py-[50px]">
          <div className="2xl:w-[1600px] xl:w-[1100px] lg:w-[850px] md:w-[700px] w-full mx-auto mnavbar">
            <div>
              <h1 className="alata font-[400] mx-auto 2xl:text-[25px] 2xl:leading-[45px] xl:text-[16px] xl:leading-[30px] text-[16px] leading-[24px] 2xl:w-[831px] xl:w-[550px] w-full text-center">
            ...
            <div className="2xl:mt-[60px] xl:mt-[40px] mt-[20px] flex flex-col sm:flex-row justify-between">
              {/* First item */}
              <div className="2xl:w-[364px] xl:w-[250px] w-full sm:w-1/2 px-4 mb-8 ">
                <Image
                  src={hygiene}
        ...
        <div className="2xl:w-[1600px] xl:w-[1100px] lg:w-[850px] md:w-[700px] w-full flex items-center mx-auto flex-col-reverse lg:flex-row mnavbar 2xl:py-[115px] xl:py-[80px] py-[50px]">
          <h1 className="alata font-[400] mx-auto 2xl:text-[25px] 2xl:leading-[45px] xl:text-[16px] xl:leading-[30px] text-[14px] leading-[22px] 2xl:w-[831px] xl:w-[550px] w-full text-center">
