...
const RefundPolicy = () => {
  return (
    <>
      <section>
        <Navbar />
        <div className="2xl:w-[1600px] mnavbar alata xl:w-[1100px] lg:w-[850px]  md:w-[600px] xs:w-[90%] sm:w-[90%]    mx-auto 2xl:py-[150px] xl:py-[120px] py-[70px] mnavbar">
          <div>
            ...
            <h2 className="2xl:text-[28px] font-[400] xl:text-[23px] lg:text-[20px] md:text-[20px]">
            ...
            <p className="footer_text mb-7 2xl:mb-10 flex items-center justify-center">
              ...
              <br></br>•The order received had food safety or hygiene issues
              or otherwise was not fit to be delivered.
              ...
              <br></br>•Notwithstanding any of the above, Authentichef
              reserves the right to refuse a refund for an order, should we feel
              the reasons stated are incorrect, inaccurate, invalid, fictitious
              or false.
              <br></br>•For all of the above, Authentichef’s decision on
              refunds shall be final and binding.
            </p>
            ...
            <p className="footer_text mb-7 2xl:mb-10">
              ...
              this Refund Policy.<br></br>
              <br></br>If you have any further questions, comments or requests
              regarding this Refund Policy, please email us at
              support@authentichef.com.<br></br> <br></br>This Refund Policy was
